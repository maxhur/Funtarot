    ...
    <div className="bg-black min-h-screen flex flex-col items-center">
      <header className="sticky top-0 z-50 w-full">
        <div className="bg-black flex flex-col items-center p-5 space-y-4">
          <h1
            className="text-2xl mb-2 sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl
          ...
          <form onSubmit={handleSubmit} className="w-full md:w-1/2 mx-auto">
            <input
              className="w-full p-2 border border-zinc-300 dark:bg-zinc-900
                   dark:border-zinc-800 rounded shadow-xl"
              value={input}
